<div class="actions">
<?php echo $this->Html->link(__('Dodaj novu stranu'), array('action' => 'add')); ?>
</div><br />
<div class="pages index">
	<h2><?php echo __('Strane');?></h2><br />
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Izmeni'), array('action' => 'edit', $page['Page']['id'])); ?>
			<?php echo $this->Form->postLink(__('Obrisi'), array('action' => 'delete', $page['Page']['id']), null, __('Da li ste sigurni da zelite da obrisete stranu: %s?', $page['Page']['title'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table><br />
